...
\begin{table}
	\centering{}%
	\pubfont 
	\begin{longtable}{|>{\centering}m{0.5cm}|>{\centering}m{5.5cm}|>{\centering}m{2.2cm}|>{\centering}m{1.5cm}|>{\centering}m{2.2cm}|>{\centering}m{1.5cm}|>{\centering}m{1cm}|}
	% 0.5, 1.8, 2.8, 2.5, 2.2, 2.0, 1.0 cm
		\hline 
		\textbf{序号}  & \textbf{发表或投稿刊物/会议名称} & \textbf{作者（仅注明第几作者）} & \textbf{发表年份} & \textbf{与学位论文哪一部分（章、节）相关} &\textbf{被索引收录情况}\tabularnewline
		\hline 
		1& 《计算机研究与发展》（CCF-A类期刊） & 导师第一，本人第二 & 拟投稿 &第三章、第四章 &  \tabularnewline
		\hline 
		% 2	 & 							&  	 &   &  &  & \tabularnewline
		% \hline 
	\end{longtable}
...
注：
1.请在“作者”一栏填写本人是第几作者，例：“第一作者”或“导师第一，本人第二”等；

\qquad 2.若文章未发表或未被接受，请在“发表年份”一栏据实填写“已投稿”，“拟投稿”。
